  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Favorites', style: TextStyle(color: Color(0xff0A947D), fontWeight:FontWeight.bold, fontSize: 25 ),),
        actions: [
                    ...
                    child: Column(
                      children: [
                        ClipRRect(
                            ...
                            child:  Image(image:NetworkImage(recipes.elementAt(index).image ,),
                            )),
                        Text(recipes.elementAt(index).name, style: TextStyle(
